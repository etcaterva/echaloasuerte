...
<h4>Crear</h4>
    ...
    <p>
      <center>
            <p><a href="Compartida/Aleatorio.php"><img  name="imgAleatorio" src="img/buttonAleatorio.png" alt="Numero aleatorio" width="264" height="230" onmouseover="swapon1()" onmouseout="swapoff1()" title="Numero aleatorio" /></a> <a href="Compartida/Eleccion.php"><img name="imgEleccion" src="img/buttonEleccion.png" alt="Elegir entre valores" width="264" height="230" onmouseover="swapon2()" onmouseout="swapoff2()" title="Elegir entre valores"/></a>
              <br />
      <a href="Compartida/Asociacion.php"><img src="img/buttonAsociacion.png" alt="Asociar valores" name="imgAsociacion" width="264" height="230" id="imgAsociacion" title="Asociar valores" onmouseover="swapon3()" onmouseout="swapoff3()"/></a> </p>
      </center>
    </p>
    <?php
	botonAyuda("
