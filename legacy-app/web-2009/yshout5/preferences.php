<?
	...
	function resetPrefs() {
		$defaultPrefs = array(
			...
			'logs' => 1,											// Amount of different log files to allow
			'history' => 5,											// Shouts to keep in history

			'inverse' => true,										// Inverse shoutbox / form on top
			...
			'defaultNickname' => 'Nombre',
			'defaultMessage' => 'Mensaje',
			'defaultSubmit' => 'Enviar!',
			'showSubmit' => true,
